[![Build Status](https://travis-ci.org/DiCaprio17/DiCaprio17.github.io.svg?branch=master)](https://travis-ci.org/DiCaprio17/DiCaprio17.github.io)
...
[![GitHub issues](https://img.shields.io/github/issues/DiCaprio17/DiCaprio17.github.io.svg?style=flat)](https://github.com/DiCaprio17/DiCaprio17.github.io/issues)
[![License MIT](https://img.shields.io/badge/license-MIT-blue.svg?style=flat)](https://github.com/home-assistant/home-assistant-iOS/blob/master/LICENSE)
[![](https://img.shields.io/github/stars/DiCaprio17/DiCaprio17.github.io.svg?style=social&label=Star)](https://github.com/DiCaprio17/DiCaprio17.github.io)
[![](https://img.shields.io/github/forks/DiCaprio17/DiCaprio17.github.io.svg?style=social&label=Fork)](https://github.com/DiCaprio17/DiCaprio17.github.io)


博客的搭建教程修改自 [Hux](https://github.com/Huxpro/huxpro.github.io) 

>
### [查看博客戳这里 👆](https://DiCaprio17.github.io)
...
SEOTitle: 安藤青司的博客 | DiCaprio Blog		# SEO 标题
description: "今日一别，从此天涯路远"	   	   # 随便说点，描述一下

# SNS settings      
github_username: dicaprio17     # 你的github账号
jianshu_username: dicaprio17  # 你的简书ID。
...
sidebar-avatar: /img/DiCaprio.jpg     #你的大头贴，请使用绝对地址.注意：名字区分大小写！后缀名也是
```
...
friends: [
    {
        title: "CSDN",
        href: "https://blog.csdn.net/qq_36910634"
    }
]
```
...
我的博客标题是 **“DiCaprio Blog”** 但是我想要在搜索的时候显示 **“安藤青司的博客 | DiCaprio Blog”** ，这个就需要 SEO Title 来定义了。
